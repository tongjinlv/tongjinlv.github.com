...
Blockly.Python['gpio_led'] = function(block) {
  ...
  var code = "gpio"+dropdown_name+".write("+value_name+")\n";
  var def ="gpio"+dropdown_name+"=mraa.Gpio("+dropdown_name+")";
  var def1 ="gpio"+dropdown_name+".dir(mraa.DIR_OUT)";
  // TODO: Change ORDER_NONE to the correct strength.
  Blockly.Python.definitions_[def] = def;
  Blockly.Python.definitions_[def1] = def1;
  Blockly.Python.definitions_['import_mraa'] = 'import mraa';
  return code;
};
...
Blockly.Python['gpio_keydown'] = function(block) {
  var dropdown_name = Blockly.Python.valueToCode(block, 'NAME', Blockly.Python.ORDER_NONE);
    try  {
     dropdown_name=eval(dropdown_name);
    }catch(exception) {
  ...
  Blockly.Python.definitions_[def] = def;
  var func="def gpio"+dropdown_name+"_callback(userdata):\n"+global;
  branchCode= Blockly.Python.statementToCode(block, 'FUNC')+Blockly.Python.PASS;
  func+=" if(gpio"+dropdown_name+".read()==False):\n" + branchCode;
  branchCode= Blockly.Python.statementToCode(block, 'FUNC1')+Blockly.Python.PASS;
  func+=' else:\n' + branchCode;
  Blockly.Python.definitions_[func] = func;
  var code ="gpio"+dropdown_name+".dir(mraa.DIR_IN)\n";
  code+="gpio"+dropdown_name+".isr(mraa.EDGE_BOTH,gpio"+dropdown_name+"_callback,None)\n";
  return code;
};