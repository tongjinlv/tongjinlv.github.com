...
Blockly.Python['iot_httpget'] = function(block) {
  var text_value =Blockly.Python.valueToCode(block, 'VALUE', Blockly.Python.ORDER_NONE);
  Blockly.Python.definitions_['import_iot'] = 'import iot';
  var code="iot.httpGet("+text_value+")";
  return [code, Blockly.Python.ORDER_NONE];
};
Blockly.Python['iot_httppost'] = function(block) {
  var text_value =Blockly.Python.valueToCode(block, 'VALUE', Blockly.Python.ORDER_NONE);
  var text_post =Blockly.Python.valueToCode(block, 'POST', Blockly.Python.ORDER_NONE);
  Blockly.Python.definitions_['import_iot'] = 'import iot';
  var code ="iot.httpPost("+text_post+","+text_value+")";
  return [code, Blockly.Python.ORDER_NONE];
};