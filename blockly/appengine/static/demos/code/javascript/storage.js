...
BlocklyStorage.handleGet_ = function() {
  ...
  if (BlocklyStorage.httpGet_.readyState == 4) {
   ...
   //   BlocklyStorage.alert(BlocklyStorage.HTTPREQUEST_ERROR + '\n' +'httpGet_.status: ' + BlocklyStorage.httpGet_.status);
     document.getElementById("runButton").innerHTML="<i class='fa fa-play' aria-hidden='true' style='color:white'></i>";
  ...
  {
      document.getElementById("runButton").innerHTML="<i class='fa fa-stop' aria-hidden='true' style='color:white'></i>";
